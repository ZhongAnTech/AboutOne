...
const (
	...
	SQL_SETTINGS_DEFAULT_DATA_SOURCE = "mmuser:1qaz2wsx@tcp(192.168.249.128:3306)/mattermost?charset=utf8mb4,utf8&readTimeout=30s&writeTimeout=30s"

	FILE_SETTINGS_DEFAULT_DIRECTORY = "./data/"

	EMAIL_SETTINGS_DEFAULT_FEEDBACK_ORGANIZATION = ""

	SUPPORT_SETTINGS_DEFAULT_TERMS_OF_SERVICE_LINK = "https://aboutOne.com/default-terms/"
	SUPPORT_SETTINGS_DEFAULT_PRIVACY_POLICY_LINK   = "https://aboutOne.com/default-privacy-policy/"
	SUPPORT_SETTINGS_DEFAULT_ABOUT_LINK            = "https://aboutOne.com/default-about/"
	SUPPORT_SETTINGS_DEFAULT_HELP_LINK             = "https://aboutOne.com/default-help/"
	SUPPORT_SETTINGS_DEFAULT_REPORT_A_PROBLEM_LINK = "https://aboutOne.com/default-report-a-problem/"
...
type FileSettings struct {
	FileTypeDocument         *string `restricted:"true"`
	FileTypeImage         *string `restricted:"true"`
	FileTypeVideo         *string `restricted:"true"`
	EnableCdms               *bool   `restricted:"true"`
	CdmsOauthServerUrl      *string `restricted:"true"`
	CdmsServerUrl           *string `restricted:"true"`
	CdmsClientId            *string `restricted:"true"`
	CdmsClientSecret        *string `restricted:"true"`
	ConvertFileType         *string `restricted:"true"`
...
type FreeSwitchSettings struct {
	Enable        bool
	Host          string
	Domain        string
	Port          uint
...
type Config struct {
	...
	ZuiFuliSettings			ZuiFuliSettings
	...
	FreeSwitchSettings      FreeSwitchSettings
}
