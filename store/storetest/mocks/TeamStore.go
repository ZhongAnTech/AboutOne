...
import store "za-white-screen/store"
...
// GetTeamsByName provides a mock function with given fields: userId
func (_m *TeamStore) GetTeamsByName(name string) store.StoreChannel {
	ret := _m.Called(name)
