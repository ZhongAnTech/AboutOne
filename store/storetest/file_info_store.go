...
func TestFileInfoStore(t *testing.T, ss store.Store) {
	...
	t.Run("FileInfoGetForChannelId", func(t *testing.T) { testFileInfoGetForChannelId(t, ss) })           //cml-20190729
	t.Run("FileInfoGetForChannelIdCount", func(t *testing.T) { testFileInfoGetForChannelIdCount(t, ss) }) //cml-20190730
	...
	t.Run("FileInfoDeleteByFileId", func(t *testing.T) { testFileInfoDeleteByFileId(t, ss) }) //cml-20190729
...
//cml-20190729
func testFileInfoGetForChannelId(t *testing.T, ss store.Store) {
	userId := model.NewId()
	userId2 := model.NewId()
	...
	userPosts, err := ss.FileInfo().GetForChannelId(channelId, 0, 10)
	require.Nil(t, err)
	assert.Len(t, userPosts, 3)

	userPosts, err = ss.FileInfo().GetForChannelId(channelId2, 0, 10)
	require.Nil(t, err)
	assert.Len(t, userPosts, 1)
}

//cml-20190731
func testFileInfoGetForChannelIdCount(t *testing.T, ss store.Store) {
	userId := model.NewId()
	userId2 := model.NewId()
	channelId := model.NewId()
	channelId2 := model.NewId()
...
//cml-20190729
func testFileInfoDeleteByFileId(t *testing.T, ss store.Store) {
	userId := model.NewId()
	postId := model.NewId()
	fileId := model.NewId()
