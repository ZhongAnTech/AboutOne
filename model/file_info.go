...
const (
	...
	CLASSIFICATION_VIDEO    = "video"
	CLASSIFICATION_OTHER    = "other"

	FILEINFO_ORDER_BY_CREATEAT = "CreateAt"
	FILEINFO_ORDER_BY_SIZE = "Size"
	FILEINFO_ORDER_BY_NAME = "Name"
...
func FilesForwarJson(data io.Reader) *fileForward {
	var o *fileForward
	json.NewDecoder(data).Decode(&o)
	return o
}
//cml-20190731 网盘对象
type FileInfoForDisk struct {
	FileInfo
	Username string `json:"user_name"`
}

//cml-20191016 文件分类查询
type FileClassificationReq struct {
	ChannelId       string `json:"channel_id"`
	Classification  string `json:"classification"`
...
func FileClassificationReqFromJson(data io.Reader) *FileClassificationReq {
	var cs *FileClassificationReq
