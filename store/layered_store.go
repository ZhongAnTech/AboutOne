...
func (s *LayeredStore) Meeting() MeetingStore {
	return s.DatabaseLayer.Meeting()
}
...
func (s *LayeredStore) Collect() CollectStore {
	return s.DatabaseLayer.Collect()
}
...
func (s *LayeredStore) FileOperation() FileOperationLogStore {
	return s.DatabaseLayer.FileOperation()
}
