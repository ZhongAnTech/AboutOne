...
type Post struct {
	...
	IsRead		  string `json:"isRead,omitempty" db:"-"`
...
//转发请求参数
type PostForwardReq struct {
	PostIds       []string   `json:"post_ids"`
	UserIds       []string   `json:"user_ids"`
	ChannelIds    []string   `json:"channel_ids"`
}

type CollectQueryReq struct {
	PostIds       []string   `json:"post_ids"`
	Type          string     `json:"type"`
}

//转发后组装新的post
type NewPostsMessage struct {
	Title string        `json:"title"`
	Data  []*SimplePost `json:"data"`
}

type SimplePosts []SimplePost
...
func (o *MeetingPost) Clone() *MeetingPost {
	copy := *o
	return &copy
}
...
func (o *MeetingPost) ToJson() string {
	copy := o.Clone()
	b, _ := json.Marshal(copy)
	return string(b)
}
...
func PostForwardReqFromJson(data io.Reader) *PostForwardReq {
	var o *PostForwardReq
	json.NewDecoder(data).Decode(&o)
	return o
}

func CollectQueryReqFromJson(data io.Reader) *CollectQueryReq {
	var o *CollectQueryReq
	json.NewDecoder(data).Decode(&o)
	return o
}

func PostsForwarJson(data io.Reader) *postForward {
	var o *postForward
	json.NewDecoder(data).Decode(&o)
	return o
}
...
func PostFromListJson(data io.Reader) *PostListBody {
	var o *PostListBody
	json.NewDecoder(data).Decode(&o)
	return o
}
func (o *PostListBody) ToJson() string {
	copy := o.Clone()
	b, _ := json.Marshal(copy)
	return string(b)
}
func (o *PostListBody) Clone() *PostListBody {
	copy := *o
	return &copy
}
...
func (o *SimplePosts) SimplePostsToJson() string {
	b, err := json.Marshal(o)
	if err != nil {
		return ""
	}
...
func (o *SimplePost) SimplePostToJson() string {
	b, err := json.Marshal(o)
	if err != nil {
		return ""
	}
