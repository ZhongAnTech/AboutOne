...
//cml-20190729 DeleteByFileId provides a mock function with given fields: fileId
func (_m *FileInfoStore) DeleteByFileId(fileId string) (string, *model.AppError) {
...
//cml-20190729 GetForChannelId provides a mock function with given fields: channelId
func (_m *FileInfoStore) GetForChannelId(channelId string, offset int, limit int) ([]*model.FileInfoForDisk, *model.AppError) {
	ret := _m.Called(channelId, offset, limit)

	var r0 []*model.FileInfoForDisk
	if rf, ok := ret.Get(0).(func(string) []*model.FileInfoForDisk); ok {
		r0 = rf(channelId)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.FileInfoForDisk)
		}
	}
...
//cml-20190731 GetForChannelIdCount provides a mock function with given fields: channelId
func (_m *FileInfoStore) GetForChannelIdCount(channelId string) (int64, *model.AppError) {
