...
type Store interface {
	...
	FileOperation() FileOperationLogStore
...
type TeamStore interface {
	...
	GetTeamsByName(name string) StoreChannel
...
type ChannelStore interface {
	...
	DisbandChannelMembers(channelId string) *model.AppError
	...
	GetOnlyByName(name string) (*model.Channel, *model.AppError)
	GetOnlyByChannelName(name string)(*model.Channel, *model.AppError)
	...
	GetAllChannelsForPosts(page,perPage int) (*model.ChannelListWithPostData,*model.AppError)
	...
	GetChannelMemberMentions(channelId ,userId string)(*model.ChannelMember, *model.AppError)
	...
	IncrementMentionCount(postId,channelId string, userId string) *model.AppError
...
type PostStore interface {
    ...
    GetSingleContainDeleted(id string) (*model.Post, *model.AppError)
	GetPostsForBatchId(batchId string) ([]*model.Post,*model.AppError)
	...
	GetLatestPost(channelId string) (*model.Post, *model.AppError)
	Search(teamId string, userId string, params *model.SearchParams) StoreChannel
	SearchMessageCount(channelIds []string,term string) (model.SearchChatCountRows, *model.AppError) //cml-20190904 搜索聊天记录按channel统计
	SearchMessage(channelIds []string,term string,offset int, limit int) ([]*model.Post, *model.AppError) //cml-20190904 分页搜索聊天记录
    ...
    GetPostsByIdsAsc(postIds []string) ([]*model.Post, *model.AppError)
...
type UserStore interface {
	...
	SaveOrUpdate(user *model.User) (*model.User,*model.AppError)
    UpdateLogin(userId string,login string) *model.AppError
	...
	GetAllUpdateProfiles(options *model.UserGetOptions) StoreChannel
	...
	GetEntityByUsername(username string) (*model.User, *model.AppError)
...
type BotStore interface {
	...
	GetByName(userId string) (*model.Bot, *model.AppError)
...
type MeetingStore interface {
	GetByRunMeetingChannelId(channelId string) (*model.Meeting, *model.AppError)
	GetAllChannelMeetings(options *model.MeetingGetOptions) ([]*model.Meeting, *model.AppError)
	GetMeetingByMeetingId(meetingId string) (*model.Meeting, *model.AppError)
	GetMeetingByNumAndStatus(meetingNum,status string) ([]*model.Meeting, *model.AppError)
	Save(meeting *model.Meeting) (*model.Meeting, *model.AppError)
	Update(meeting *model.Meeting) (*model.Meeting, *model.AppError)
	PermanentDelete(channelId,meetingId string) *model.AppError
	GetMeetingRoom(flag string)(*model.MeetingRoom, *model.AppError)
	GetAllUpdateMeetings() StoreChannel
	GetAllOpenMeetings() StoreChannel
	LockRoomStatus(room *model.MeetingRoom) (int64, *model.AppError)
	UnLockRoomStatus(room *model.MeetingRoom) (int64, *model.AppError)
	SaveMeetingMember(member *model.MeetingMembers)(*model.MeetingMembers,*model.AppError)
	DeleteMeetingMember(meetingId,userName string)(*model.AppError)
	GetMeetingMember(meetingId string)([]*model.MeetingMembers,*model.AppError)
	MeetingMemberHeartBeat(member *model.MeetingMembers)(*model.MeetingMembers,*model.AppError)
}
...
type CommandStore interface {
	...
	GetCommandTypes(teamId string) ([]*string, *model.AppError)
	GetAllByTeam(teamId string) ([]*model.Command, *model.AppError)
	GetAllByTeamAndType(teamId,commandType string) ([]*model.Command, *model.AppError)
...
type PreferenceStore interface {
    ...
    GetByCategory(category string,limt int) (model.Preferences, *model.AppError)
...
type CollectStore interface {
	Insert(collect *model.Collect) (*model.Collect, *model.AppError)
	Search(collector string,postId string,postIds string,term string,offset int, limit int) ([]*model.Collect, *model.AppError)
    SearchMerg(collector string,postIds string,offset int, limit int) ([]*model.Collect, *model.AppError)
	DeleteById(id string) *model.AppError
	Get(id string) (*model.Collect, *model.AppError)
}
...
type FileInfoStore interface {
	...
	Update(Id, path, channelId string) (*model.AppError)
	UpdateImagePath(Id, path, channelId,previewPath,thumbnailPath string) (*model.AppError)
	Get(id string) (*model.FileInfo, *model.AppError)
    GetContainDeleted(id string) (*model.FileInfo, *model.AppError)
	...
	GetForChannelId(channelId string, offset int, limit int) ([]*model.FileInfoForDisk, *model.AppError) //cml-20190729
	GetForChannelIdCount(channelId string) (int64, *model.AppError)                                      //cml-20190731
    GetForChannelIdsForName(channelIds []string,name string,offset int, limit int) ([]*model.FileInfoForDisk, *model.AppError)//cml-20190902
	GetForChannelIdForNameCount(channelIds []string,name string)(int64, *model.AppError)//cml-20190902
	GetForChannelIdAll(channelId string, offset int, limit int) ([]*model.FileInfoForDisk, *model.AppError) //cml-20190903
	SearchFileCountByChannels(channelIds []string,term string) (model.SearchChatCountRows, *model.AppError) //cml-20190904
    SearchFileByChannels(channelIds []string,term string,page int, perPage int) ([]*model.FileInfoForDisk, *model.AppError) //cml-20190904
    ClassificationQuery(fileClassificationReq *model.FileClassificationReq) ([]*model.FileInfo, *model.AppError)//cml-20191016
    ClassificationQueryCount(fileClassificationReq *model.FileClassificationReq) (int64, *model.AppError)//cml-20191016
	GetAllByClassificationIsEmpty(offset int, limit int) ([]*model.FileInfo, *model.AppError)//cml-20191017
    GetAll(offset int, limit int) ([]*model.FileInfo, *model.AppError)
	UpdateFileClassification(fileId, classification string) *model.AppError//cml-20191017
	...
	DeleteByFileId(fileId string) (string, *model.AppError) //cml-20190729
	PermanentDelete(fileId string) *model.AppError
	PermanentDeleteBatch(endTime int64, limit int64) (int64, *model.AppError)
	PermanentDeleteByUser(userId string) (int64, *model.AppError)
	ClearCaches()
}
type FileOperationLogStore interface {
	Save(info *model.FileOperationLog) (*model.FileOperationLog, *model.AppError)
	Get(id string) (*model.FileOperationLog, *model.AppError)
	GetByChannelId(channelId string) ([]*model.FileOperationLog, *model.AppError)
	GetByFileInfoId(fileInfoId string) ([]*model.FileOperationLog, *model.AppError)
	GetByChannelIdAndFileInfoId(channelId, fileId string, offset int, limit int) ([]*model.FileOperationLogForDisk, *model.AppError)
	GetByChannelIdAndFileInfoIdCount(channelId, fileInfoId string) (int64, *model.AppError) //cml-20190731
}
