...
const (
	...
	WEBSOCKET_EVENT_MEETING                  = "meeting"
	WEBSOCKET_EVENT_MEETING_JOIN            ="meeting_join"
	WEBSOCKET_EVENT_MEETING_OUT             ="meeting_out"
	WEBSOCKET_EVENT_MEETING_UPDATE          ="meeting_update"
	WEBSOCKET_EVENT_MEETING_CLOSE          ="meeting_close"
	WEBSOCKET_EVENT_MEETING_LIVE          ="meeting_live"
	WEBSOCKET_EVENT_COMMAND_HUBOT		   ="command_hubot"
)
...
type RedisWebSocketEvent struct {
	IP  string      `json:"ip"`
	WebSocketEvent  *WebSocketEvent `json:"webSocketEvent"`
}
