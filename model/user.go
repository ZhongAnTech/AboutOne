...
import (
	...
	"sort"
	"strings"
	"za-white-screen/services/timezones"
...
const (
	...
	END_TIME                           = "end_time"
	MEETING_NOTIFY_STATUS              = "meeting_notify_status"
...
func (u *User) PreSave() {
	...
	if u.Login == ""{//默认未登录 cml-20191021
		u.Login = USER_LOGIN_0
	}
}
...
func (u *User) SetDefaultNotifications() {
	...
	u.NotifyProps[START_TIME] = ""
	u.NotifyProps[END_TIME] = ""
	u.NotifyProps[MEETING_NOTIFY_STATUS] = ""
	u.NotifyProps[MEETING_STATUS] = ""
	u.NotifyProps[UNREAD] = "true"
