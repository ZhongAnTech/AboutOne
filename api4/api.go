...
type Routes struct {
	...
	FileOperationLog *mux.Router// 'api/v4/filelogs'
	FileLogChannelId *mux.Router // 'api/v4/filelogs/{channel_id:}'
	FileLogChannelAndFileId *mux.Router // 'api/v4/filelogs/{file_id:xx,channel_id:xx}'
	FileLogFileId *mux.Router// 'api/v4/filelogs/{file_id:}'
	...
	Hubot *mux.Router // 'api/v4/hubot'
	Command  *mux.Router // 'api/v4/commands/{command_id:[A-Za-z0-9]+}'
	Test     *mux.Router // 'api/v4/test'
...
func Init(configservice configservice.ConfigService, globalOptionsFunc app.AppOptionCreator, root *mux.Router) *API {
	...
	api.BaseRoutes.Meeting = api.BaseRoutes.ApiRoot.PathPrefix("/meeting").Subrouter()
	api.BaseRoutes.ZflMeeting = api.BaseRoutes.ApiRoot.PathPrefix("/zfl/meeting").Subrouter()
	...
	api.BaseRoutes.FileOperationLog = api.BaseRoutes.ApiRoot.PathPrefix("/filelogs").Subrouter()
	api.BaseRoutes.FileLogFileId = api.BaseRoutes.FileOperationLog.PathPrefix("/file").Subrouter()
	api.BaseRoutes.FileLogChannelId = api.BaseRoutes.FileOperationLog.PathPrefix("/channel").Subrouter()
	api.BaseRoutes.FileLogChannelAndFileId = api.BaseRoutes.FileOperationLog.PathPrefix("/{channel_id:[A-Za-z0-9]+}/{file_id:[A-Za-z0-9]+}").Subrouter()
	...
	api.BaseRoutes.Hubot = api.BaseRoutes.ApiRoot.PathPrefix("/hubot").Subrouter()
